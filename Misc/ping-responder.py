...
# Found here: https://github.com/PixelsCamp/ping-responder/blob/master/src/ping-responder.py
# Requirements: pip setuptools wheel scapy==2.4
# Fixed line 208
...
def main():
    ...
    sniff(filter="icmp and icmp[icmptype] == 8", prn=capture_cb, store=0)
